...
export const PRESETS: Record<string, Partial<GradualBlurConfig>> = {
...
export const CURVE_FUNCTIONS: Record<Curve, (p: number) => number> = {
  linear: (p) => p,
  bezier: (p) => p * p * (3 - 2 * p),
  "ease-in": (p) => p * p,
...
const mergeConfigs = (
  ...configs: Array<Partial<GradualBlurConfig> | undefined>
): GradualBlurConfig => {
