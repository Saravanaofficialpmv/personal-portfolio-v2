...
const StickerPeel: React.FC<StickerPeelProps> = ({
  ...
  }, [peelDirection, lightingIntensity]);
  ...
  return (
    <div className={`${isDraggable ? 'draggable' : 'relative w-full'} ${isCircle ? 'is-circle' : ''} ${className}`} ref={dragTargetRef} style={cssVars}>
      <svg width="0" height="0">
        <defs>
          ...
          <filter id="expandAndFill">
            ...
            <feFlood floodColor="rgb(220,220,225)" result="flood" />
          ...
          <div className="flap-lighting">
            {flapContent ? (
              ...
              <div className="w-full h-full relative overflow-hidden">
                {children}
                <div className="absolute inset-0 bg-[#E2E2E5]/80 mix-blend-multiply pointer-events-none" />
              </div>
            ) : imageSrc ? (
              <img
                src={imageSrc}
