            ...
            <div className="flex items-center gap-3 flex-wrap">
              {isModalAction ? (
                ...
                project.linkUrl && (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#171717] text-white text-xs uppercase tracking-wider font-medium hover:bg-[#333333] transition-all duration-200 shadow-sm"
                  >
              ...
              {project.githubUrl && (
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/80 hover:bg-white text-[#171717] border border-[#171717]/15 text-xs uppercase tracking-wider font-medium transition-all duration-200 shadow-xs hover:border-[#171717]/35"
                >
                  ...
                  <span>{project.githubText || "GitHub"}</span>
                </Link>
              )}
            </div>
          </div>
