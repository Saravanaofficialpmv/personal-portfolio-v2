      ...
      <section className="w-full max-w-[1168px] flex flex-col items-center gap-8 text-center">
        ...
        >
          {["FRAME 1", "FRAME 2", "FRAME 3"].map((frameText, i) => (
            <div
              key={i}
              className="relative h-44 sm:h-80 md:h-96 rounded-xl sm:rounded-2xl border border-[#E0E0E0] bg-[#F7F7F7] flex flex-col items-center justify-center p-2 sm:p-4 select-none shadow-xs"
            >
